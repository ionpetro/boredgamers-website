...
export default function Hero() {
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <a target="_blank" href="https://www.youtube.com/@BoredGamersOfficial/videos" rel="noopener noreferrer">
                <div className={styles.item}
                    ...
                    <h3 className={styles.text} style={{ display: showVideoText }}>Videos</h3>
                </div></a>
            <div className={styles.row2}>
                <div className={styles.spoImage}>
                    <Link href="#sponsors"><div className={styles.item}
                        onMouseEnter={(e) => setShowSponsorsText('block')}
                        onMouseLeave={(e) => setShowSponsorsText('none')}>
                        <Image src='/images/sponsors.png' width={250} height={150} priority />
                        <h3 className={styles.text} style={{ display: showSponsorsText }}>Sponsors</h3>
                    </div>
                    </Link>
                </div>
                <Link href="#merch"><div className={styles.item}
                    ...
                    <h3 className={styles.text} style={{ display: showMerchText }}>Merch</h3>
                </div></Link>
